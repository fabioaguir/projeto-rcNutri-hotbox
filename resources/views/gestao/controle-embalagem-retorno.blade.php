...
@section('title')
    @parent
    RELAÇÃO DE RETORNO DE EMBALAGENS
@endsection
...
@section('page-heading')
    <h1>RELAÇÃO DE RETORNO DE EMBALAGENS</h1>
@endsection
            ...
            <div class="col-sm-12">
                ...
                <div class="panel panel-default" data-widget='{"draggable": "false"}'>
                    <div class="panel-heading">
                        <h2>RELAÇÃO DE RETORNO DE EMBALAGENS</h2>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="table-responsive">
                                    <table id="controleEmbalagemRetornadas-grid" class="display table table-bordered"
                                        ...
                                        <tr>
                                            ...
                                            <th style="width: 7%">Qtd. Retornadas</th>
                                        </tr>
                                        </thead>
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        $('#controleEmbalagemRetornadas-grid tfoot th').each(function () {
            var title = $(this).text();
        ...
        var table = $('#controleEmbalagemRetornadas-grid').DataTable({
            processing: true,
            serverSide: true,
            iDisplayLength: 20,
            bLengthChange: false,
            bFilter: false,
            ajax: {
                url: "{!! route('gestao.controleEmbalagemRetornadas') !!}",
                method: 'POST',
                data: function (d) {
