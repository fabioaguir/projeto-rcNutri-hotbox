            ...
            <div class="col-sm-12">
                ...
                <div class="panel panel-default" data-widget='{"draggable": "false"}'>
                    <div class="panel-heading">
                        <h2>Lista de Rotas</h2><br />

                        <a href="{{ route('rota.create')}}" class="btn btn-primary">Nova Rota</a>
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table id="rota-grid" class="display table table-bordered" cellspacing="0" width="100%">
                                <thead>
                                <tr>
                                    <th>Código</th>
                                    <th>Nome</th>
