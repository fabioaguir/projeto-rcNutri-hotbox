        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="panel panel-default" data-widget='{"draggable": "false"}'>
                    ...
                    {!! Form::model($user, ['route'=> ['user.update', $user->id], 'method' => "POST", 'class' => 'form-horizontal row-border','enctype' => 'multipart/form-data' ]) !!}
                    ...
                    <div class="panel-footer">
                        <div class="row">
                            <div class="col-sm-8 col-sm-offset-1">
                                <button type="submit" class="btn-primary btn" style="margin-left: 22px">Salvar</button>
                                <a class="btn-default btn" href="{{ route('user.index')}}">Voltar</a>
                            </div>
                        </div>
                    </div>
                    {!! Form::close() !!}
