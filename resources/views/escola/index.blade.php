            ...
            <div class="col-sm-12">
                ...
                <div class="panel panel-default" data-widget='{"draggable": "false"}'>
                    <div class="panel-heading">
                        ...
                        <a href="{{ route('escola.create')}}" class="btn btn-primary">Nova Escola</a>
                    ...
                    <div class="panel-body">
                        <div class="table-responsive no-padding">
                            <table id="escola-grid" class="display table table-bordered" cellspacing="0" width="100%">
                                <thead>
                                <tr>
                                    <th>Código</th>
                                    <th>Nome</th>
