            ...
            <div class="col-sm-12">
                ...
                <div class="panel panel-default" data-widget='{"draggable": "false"}'>
                    <div class="panel-heading">
                        <h2>Editar Saída das Embalagens</h2>
                        <div class="panel-ctrls" data-actions-container=""
                             data-action-collapse='{"target": ".panel-body"}'></div>
                    </div>

                    {!! Form::model($model, ['route'=> ['controleSaidaEmbalagem.update', $model->id], 'id' => 'formControleSaidaEmbalagem', 'class' => 'form-horizontal row-border']) !!}
