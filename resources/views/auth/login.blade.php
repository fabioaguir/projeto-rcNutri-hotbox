...
<div class="container" id="login-form">
    <a href="https://rcnutryalimentacao.com.br/wp/" target="_blank" class="login-logo"><img src="{{ asset('/img/logo.png')}}"></a>
    <div class="row">
        <div class="col-md-4 col-md-offset-4">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    {!! Form::open(['url' => 'login', 'method' => "POST", 'class' => 'form-horizontal', 'id' => 'validate-form']) !!}
                    {!! csrf_field() !!}
